...
describe('main navigation', () => {
    ...
    test('Artiklid navigates to the articles list', async () => {
        ...
        expect(await helper.getText('nav a.active')).toBe('ARTIKLID');
    });
